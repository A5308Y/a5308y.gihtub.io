...
I honestly don't really get why <strong>links </strong>are in the list as well. Can't a JSON-API without links to other resources still be resource oriented? I'll just ignore it for this post and I'll also ignore the <strong>connectedness</strong> property because the article is "calling the quality of having links connectedness<strong>."</strong>
